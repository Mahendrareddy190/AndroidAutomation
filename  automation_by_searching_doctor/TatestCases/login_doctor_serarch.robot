...
search doctor
    ...
    input text    com.practo.fabric:id/search_bar   Sumanth Shetty
...
bookAppointment
     ...
     wait until page contains element    com.practo.fabric:id/next_availability_button   10
     click element    com.practo.fabric:id/next_availability_button
